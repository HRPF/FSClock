...
public class DigitalClockFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.digital_clock, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        TextClock hh = (TextClock) getView().findViewById(R.id.hh);
        TextClock aa = (TextClock) getView().findViewById(R.id.aa);
        TextClock mm = (TextClock) getView().findViewById(R.id.mm);
        TextClock ss = (TextClock) getView().findViewById(R.id.ss);
